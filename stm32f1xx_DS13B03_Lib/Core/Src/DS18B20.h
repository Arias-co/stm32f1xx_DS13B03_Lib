 ...
 */
uint8_t DS18B20_Read( OneWire_t * OneWireStruct, uint8_t * ROM,
        float * destination );
 ...
 *            - > 0: High alarm set OK
 */
uint8_t DS18B20_SetAlarmHighTemperature( OneWire_t * OneWireStruct,
        uint8_t * ROM, int8_t temp );
 ...
 *            - > 0: Low alarm set OK
 */
uint8_t DS18B20_SetAlarmLowTemperature( OneWire_t * OneWireStruct,
        uint8_t * ROM, int8_t temp );
 ...
 *            - > 0: Alarm disabled OK
 */
uint8_t DS18B20_DisableAlarmTemperature( OneWire_t * OneWireStruct,
        uint8_t * ROM );
